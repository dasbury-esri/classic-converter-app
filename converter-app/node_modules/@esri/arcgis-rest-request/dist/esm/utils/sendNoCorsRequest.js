 ...
 * @returns
 */
export function sendNoCorsRequest(url) {
 ...
 * @returns
 */
export function getRegisteredNoCorsDomains() {
 ...
 */
export function registerNoCorsDomains(authorizedCrossOriginNoCorsDomains) {
 ...
 * @returns
 */
export function isNoCorsDomain(url) {
    var result = false;
    if (requestConfig.noCorsDomains.length) {
        ...
        result = requestConfig.noCorsDomains.some(function (domain) {
 ...
 * @returns
 */
export function isNoCorsRequestRequired(url) {
    var result = false;
    ...
    if (isNoCorsDomain(url)) {
        ...
        var lastRequest = requestConfig.crossOriginNoCorsDomains[origin_2] || 0;
