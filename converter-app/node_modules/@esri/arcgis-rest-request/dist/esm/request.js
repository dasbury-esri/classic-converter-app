...
import { isNoCorsDomain, isNoCorsRequestRequired, registerNoCorsDomains, sendNoCorsRequest, } from "./utils/sendNoCorsRequest";
...
export function request(url, requestOptions) {
    ...
    var requiresNoCors = !sameOrigin && isNoCorsRequestRequired(url);
