...
import { request, ArcGISAuthError, cleanUrl, encodeQueryString, decodeQueryString, isNoCorsDomain, } from "@esri/arcgis-rest-request";
...
var UserSession = /** @class */ (function () {
    ...
    UserSession.prototype.getDomainCredentials = function (url) {
        ...
        var shouldInclude = isNoCorsDomain(url);
        if (shouldInclude) {
            return "include";
        }
